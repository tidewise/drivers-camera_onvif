...
SOAP_SOURCE_STAMP("@(#) wsddC.cpp ver 2.8.60 2019-10-02 19:06:44 GMT")
...
{	(void)type;
	...
	{	char **s;
		s = soap_in__wsdd__Types(soap, NULL, NULL, "xsd:QName");
		return s ? *s : NULL;
	}
	...
	{	char **s;
		s = soap_in_wsdd__QNameListType(soap, NULL, NULL, "xsd:QName");
		return s ? *s : NULL;
	}
	...
	{	const char *t = soap->type;
		...
		{	char **s;
			*type = SOAP_TYPE__wsdd__Types;
			s = soap_in__wsdd__Types(soap, NULL, NULL, NULL);
			return s ? *s : NULL;
		}
...
{	(void)tag;
	...
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in wsddC.cpp\n", tag ? tag : "", type));
